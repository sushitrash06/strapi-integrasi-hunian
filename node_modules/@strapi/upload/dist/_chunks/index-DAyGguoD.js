...
const admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./App-mYN9RY7N.js")).then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await Promise.resolve().then(() => require("./SettingsPage-RMoqCzdS.js"));
...
//# sourceMappingURL=index-DAyGguoD.js.map
